...
def dataloader():
  ...
  y_train = np.resize(y_train,(y_train.shape[0], X_train.shape[1], X_train.shape[2], 12))
  y_val = np.resize(y_val,(y_val.shape[0], X_val.shape[1], X_val.shape[2], 12))
  y_test = np.resize(y_test,(y_test.shape[0], X_test.shape[1], X_test.shape[2], 12))
